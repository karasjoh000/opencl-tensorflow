...
#
#
# OPENCL WITH TENSOR FLOW. 
#
# https://developer.codeplay.com/products/computecpp/ce/guides/tensorflow-guide/tensorflow-generic-setup?


RUN mkdir /home/stuff 
WORKDIR "/home/stuff"

RUN apt-get install wget -y 
RUN wget --referer http://support.amd.com/ https://www2.ati.com/drivers/linux/ubuntu/amdgpu-pro-17.50-511655.tar.xz \
